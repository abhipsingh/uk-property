...
class PropertiesController < ActionController::Base
  ...
  def edit_property_details
    ...
    attributes = [
                  ...
                  :inner_area, :outer_area, :property_brochure_url, :video_walkthrough_url, :area_type
                ]
